...
@Index("FK_CONTASRECEBER_LOCAL", ["portador"], {})
@Index("FK_G026_G004_idx", ["idg004"], {})
@Entity("G026", { schema: "metodista_local" })
export class G026 {
  @PrimaryGeneratedColumn({ type: "int", name: "IDG026" })
  idg026: number;
  ...
  @Column("int", { name: "IDADICIONALRECEITA", nullable: true })
  idadicionalreceita: number | null;

  @ManyToOne(() => G004, (g004) => g004.gs2, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @OneToMany(() => G036, (g036) => g036.idg02)
  gs: G036[];

  @OneToMany(() => G050, (g050) => g050.titulo2)
  gs2: G050[];
}
