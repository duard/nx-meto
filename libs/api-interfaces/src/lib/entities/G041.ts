...
@Index("FK_G041_G001_idx", ["idg001"], {})
@Index("FK_G041_G003_idx", ["idg003"], {})
@Index("FK_G041_G004_idx", ["idg004"], {})
@Entity("G041", { schema: "metodista_local" })
export class G041 {
  @PrimaryGeneratedColumn({ type: "int", name: "IDG041" })
  idg041: number;
  ...
  @OneToMany(() => A001, (a001) => a001.idg13)
  as: A001[];

  @OneToMany(() => E024, (e024) => e024.idg04)
  es: E024[];

  @ManyToOne(() => G001, (g001) => g001.gs3, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
