...
@Index("FK_G045_G001_idx", ["idg001"], {})
@Index("FK_G045_G003_idx", ["idg003"], {})
@Index("FK_G045_G004_idx", ["idg004"], {})
@Entity("G045", { schema: "metodista_local" })
export class G045 {
  @PrimaryGeneratedColumn({ type: "int", name: "IDG045" })
  idg045: number;
  ...
  @OneToMany(() => A001, (a001) => a001.idg16)
  as: A001[];

  @OneToMany(() => E024, (e024) => e024.idg07)
  es: E024[];

  @ManyToOne(() => G001, (g001) => g001.gs6, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
